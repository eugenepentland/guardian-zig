...
const entries = [_]Entry{
    .{ .name = "durable-write-errors", .text = "Preserve errors from declared durable writes. Configure [[contract]] entries with kind, functions, operations, declaration-scoped allow, and reason. Review findings are advisory, not proof of a bug. Run contract-audit --contracts profile.toml --json for an unfiltered read-only report. See docs/operation-contracts.md for schema, examples and analysis limits." },
    .{ .name = "persistent-read-errors", .text = "Keep persistent read failures distinct from absence. Configure [[contract]] entries with kind, functions, operations, declaration-scoped allow, and reason. Review findings are advisory, not proof of a bug. Run contract-audit --contracts profile.toml --json for an unfiltered read-only report. See docs/operation-contracts.md for schema, examples and analysis limits." },
    .{ .name = "mutation-boundary", .text = "Require raw mutations to stay inside declared owners. Configure [[contract]] entries with kind, functions, operations, declaration-scoped allow, and reason. Review findings are advisory, not proof of a bug. Run contract-audit --contracts profile.toml --json for an unfiltered read-only report. See docs/operation-contracts.md for schema, examples and analysis limits." },
    .{ .name = "request-decoding", .text = "Require raw request parsing to stay inside declared decoders. Configure [[contract]] entries with kind, functions, operations, declaration-scoped allow, and reason. Review findings are advisory, not proof of a bug. Run contract-audit --contracts profile.toml --json for an unfiltered read-only report. See docs/operation-contracts.md for schema, examples and analysis limits." },
    .{ .name = "edit-identity", .text = "Report edits lacking verified identity and revision evidence. Configure [[contract]] entries with kind, functions, operations, declaration-scoped allow, and reason. Review findings are advisory, not proof of a bug. Run contract-audit --contracts profile.toml --json for an unfiltered read-only report. See docs/operation-contracts.md for schema, examples and analysis limits." },
    .{ .name = "contract-audit", .text = "Report operation contracts read-only, with separate violation and review counts. Configure [[contract]] entries with kind, functions, operations, declaration-scoped allow, and reason. Review findings are advisory, not proof of a bug. Run contract-audit --contracts profile.toml --json for an unfiltered read-only report. See docs/operation-contracts.md for schema, examples and analysis limits." },
